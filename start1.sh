...
##############################
buyer=$(wget -qO- https://raw.githubusercontent.com/Hackerslot1337/windows/main/username)
buyerexp=$(wget -qO- https://raw.githubusercontent.com/Hackerslot1337/windows/main/expred)
versi=$(wget -qO- https://raw.githubusercontent.com/Hackerslot1337/windows/main/versi)
...
if [[ "$today" > "$valid" ]]; then
  ...
  echo -e "${BG_RED}        Telegram: @hackerslot                ${NC}"
...
while true; do
    ...
    echo -e "${green} │${NC} ${YELLOW}Creator         :${NC} ${red}hackerslot${NC}"
    echo -e "${green} │${NC} ${YELLOW}MyTeam          :${NC} ${red}HACKNCORP${NC}"
    ...
    if [[ "$Manufacturer" == "Linode" ]]; then
       ...
       echo -e "${red}Contact Develop hackerslot${NC}"
    ...
    wget --no-check-certificate -qO RDP.sh 'https://raw.githubusercontent.com/Hackerslot1337/windows/main/InstallNET1.sh' && chmod a+x RDP.sh
